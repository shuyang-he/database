...
public class BPlusTreeTest {
	...
	@Test
	public void testSimpleInsertD3() {
		BPlusTree bt = new BPlusTree(3);
		bt.insert(new Entry(new IntField(9), 0));
		bt.insert(new Entry(new IntField(4), 1));
		assertTrue(bt.getRoot().isLeafNode());
	...
	@Test
	public void testComplexInsertD3() {
	...
	@Test
	public void testDeleteD3Simple() {
		// Create a tree, then delete some values
	...
	@Test
	public void testDeleteD3Complex() {
		// Create a tree, then delete some values
